...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineMedium: TextStyle().copyWith(fontSize: 25, fontWeight: FontWeight.w600, color: Colors.black),
    ...
    bodySmall: TextStyle().copyWith(fontSize: 14, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.5)),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineMedium: TextStyle().copyWith(fontSize: 25, fontWeight: FontWeight.w600, color: Colors.white),
    ...
    bodySmall: TextStyle().copyWith(fontSize: 14, fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.5)),
